...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/databricks-cli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6535&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/databricks-cli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `databricks-cli` can be installed with:

```
conda install databricks-cli
```

It is possible to list all of the versions of `databricks-cli` available on your platform with:
