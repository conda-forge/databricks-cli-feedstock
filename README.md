...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/databricks-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/databricks-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add databricks-cli
# for installing globally
pixi global install databricks-cli
```
...
It is possible to list all of the versions of `databricks-cli` available on your platform:
...
```
pixi search databricks-cli --channel conda-forge
```
